...
const EditTours = () => {
  ...
  const getData = async () => {
    try {
      ...
      setData(res.data);
      addForm.setValue("title", res.data.title);
      addForm.setValue("city", res.data.city);
      addForm.setValue("address", res.data.address);
      addForm.setValue("description", res.data.description);
      addForm.setValue("price", res.data.price);
      addForm.setValue("maxGroupSize", res.data.maxGroupSize);
      addForm.setValue("tourDate", formatDate(res.data.tourDate));
    } catch (err) {
      console.log(err);
    }
  };
